#
#  Be sure to run `pod spec lint ENMBadgedBarButtonItem.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.source_files  = "ENMBadgedBarButton/*.swift"
  s.exclude_files = "Classes/Exclude"

  s.public_header_files = "ENMBadgedBarButton/*.h"
